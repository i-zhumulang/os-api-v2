...
CREATE TABLE `module_menu` (
  ...
  `role_module_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '角色-模块ID',
  `system_menu_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '菜单ID(v2_system.menu表ID)',
...
INSERT INTO `module_menu` VALUES (1,1,1),(2,1,2),(3,1,3);
