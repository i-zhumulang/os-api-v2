...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='模块';
...
INSERT INTO `module` VALUES (1,'SYSTEM','系统管理','http://127.0.0.1:8080','/system/module/index',0),(2,'USER','个人中心','http://127.0.0.1:8080','/user/user/index',0);
