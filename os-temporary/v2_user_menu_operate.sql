...
CREATE TABLE `menu_operate` (
  ...
  `module_menu_id` int(10) unsigned NOT NULL COMMENT '模块-菜单ID',
  `system_menu_operate_id` int(10) unsigned NOT NULL COMMENT '操作ID',
  `sorting` tinyint(3) unsigned NOT NULL COMMENT '排序',
...
-- Dump completed on 2022-08-08 23:48:22
