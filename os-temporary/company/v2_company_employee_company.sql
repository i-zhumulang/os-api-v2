...
CREATE TABLE `employee_company` (
  ...
  `clique_id` bigint(20) unsigned NOT NULL COMMENT '集团ID',
  `company_id` bigint(20) unsigned NOT NULL COMMENT '公司ID',
  `employee_id` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '员工ID',
  `entry_date` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '入职日期',
  `resign_date` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '离职日期',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='员工-公司信息表';
