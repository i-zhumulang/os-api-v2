...
CREATE TABLE `company_position` (
  ...
  `pid` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '上级职位ID',
  `name` varchar(30) NOT NULL DEFAULT '' COMMENT '职位名称',
  `state` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '状态',
  `company_id` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '所属公司ID',
  `clique_id` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '所属集团ID',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='公司-职位表';
