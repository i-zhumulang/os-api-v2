...
CREATE TABLE `clique` (
  `id` bigint(20) unsigned NOT NULL COMMENT '集团ID',
  `name` varchar(30) NOT NULL DEFAULT '' COMMENT '集团名称',
  `created_at` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `deleted_state` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '删除状态',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='集团-主表';
